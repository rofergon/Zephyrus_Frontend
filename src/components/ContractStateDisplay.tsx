...
interface ContractStateDisplayProps {
  contractState: ContractState[];
}

const ContractStateDisplay: React.FC<ContractStateDisplayProps> = ({ contractState }) => {
  return (
    <div className="mb-8">
...
export default ContractStateDisplay; 